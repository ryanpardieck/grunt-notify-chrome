...
function choosePlatform() {
  ...
  // For now just going to assume that if you have this plugin installed, 
  // then you want to use the chrome notifications.

  var chrome_notify = require('./platforms/chrome-notify');

  if (true) {
    return chrome_notify;
  }
